...
const UpcomingCard = ({ card }) => {
  return (
    <div
      style={{
        backgroundImage: `url('/frames/upcoming_${card.img}.png')`,
      }}
      className={`p-10 bg-cover h-80 flex flex-col gap-4 justify-end rounded-2xl max-sm:p-6 max-sm:gap-3 max-sm:bg-top`}
    >
